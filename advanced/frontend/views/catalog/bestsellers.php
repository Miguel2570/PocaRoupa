...
/** @var array $products */
use yii\helpers\Url;
$this->title = 'PocaRoupa - Mais Vendidos';
?>
                ...
                <nav class="p-2">
                    <ul class="space-y-1">
                        ...
                        $cats = [
                            ...
                            ['l'=>'Mais Vendidos', 'i'=>'fa-shopping-bag', 'u'=>'site/bestsellers', 'a'=>true], // Ativo
                            ['l'=>'Novidades', 'i'=>'fa-plus-square', 'u'=>'site/new', 'a'=>false],
        ...
        <div class="lg:col-span-9">
            ...
            <div class="mb-12 text-center py-6">
                <div class="inline-flex items-center gap-3 bg-gradient-to-r from-rose-500 to-pink-500 text-white px-8 py-4 rounded-full mb-4 shadow-lg">
                    ...
                    <span class="text-xl font-bold">Mais Vendidos</span>
                </div>
                <p class="text-gray-600 text-lg">Os produtos favoritos das nossas clientes</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php if (count($products) > 0): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="col-span-3 text-center py-10 text-gray-500">Ainda não temos bestsellers definidos.</div>
                <?php endif; ?>
            </div>

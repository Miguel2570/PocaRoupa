    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <nav class="p-2">
                    <ul class="space-y-1">
                        ...
                        $cats = [
                            ...
                            ['l'=>'Mais Vendidos', 'i'=>'fa-shopping-bag', 'u'=>'site/index', 'a'=>false],
                            ['l'=>'Novidades', 'i'=>'fa-plus-square', 'u'=>'site/index', 'a'=>false],
                            ['l'=>'Roupa', 'i'=>'fa-tshirt', 'u'=>'site/clothing', 'a'=>true], // Ativo
        ...
        <div class="lg:col-span-9">
            ...
            <div class="mb-12 text-center py-6">
                <div class="inline-flex items-center gap-3 bg-gradient-to-r from-rose-500 to-pink-500 text-white px-8 py-4 rounded-full mb-4 shadow-lg">
                    <i class="fas fa-tshirt text-2xl"></i>
                    <span class="text-xl font-bold">Roupa</span>
                </div>
                <p class="text-gray-600 text-lg">Encontre o look perfeito para cada ocasião</p>
            </div>

            <div class="flex gap-4 mb-8 flex-wrap justify-center">
                <button class="px-6 py-2 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-full shadow-md hover:shadow-lg transition-all font-medium">Todos</button>
                <button class="px-6 py-2 bg-white text-gray-700 rounded-full border-2 border-pink-200 hover:border-pink-400 transition-all font-medium">Vestidos</button>
                <button class="px-6 py-2 bg-white text-gray-700 rounded-full border-2 border-pink-200 hover:border-pink-400 transition-all font-medium">Blusas</button>
                <button class="px-6 py-2 bg-white text-gray-700 rounded-full border-2 border-pink-200 hover:border-pink-400 transition-all font-medium">Calças</button>
            </div>

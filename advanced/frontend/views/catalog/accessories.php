...
/** @var array $products */
use yii\helpers\Url;
$this->title = 'PocaRoupa - Acessórios';
?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <nav class="p-2">
                    <ul class="space-y-1">
                        ...
                        $cats = [
                            ...
                            ['l'=>'Acessórios', 'i'=>'fa-clock', 'u'=>'site/accessories', 'a'=>true], // Ativo
        ...
        <div class="lg:col-span-9">
            ...
            <div class="mb-12 text-center py-6">
                ...
                <p class="text-gray-600 text-lg">Complete o seu visual com estilo</p>
            </div>

            <div class="flex gap-4 mb-8 flex-wrap justify-center">
                <button class="px-6 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full shadow-md hover:shadow-lg transition-all font-medium">Todos</button>
                <button class="px-6 py-2 bg-white text-gray-700 rounded-full border-2 border-purple-200 hover:border-purple-400 transition-all font-medium">Bolsas</button>
                <button class="px-6 py-2 bg-white text-gray-700 rounded-full border-2 border-purple-200 hover:border-purple-400 transition-all font-medium">Joias</button>
                <button class="px-6 py-2 bg-white text-gray-700 rounded-full border-2 border-purple-200 hover:border-purple-400 transition-all font-medium">Calçado</button>
            </div>
